...
<div class="container-fluid mt-4">
  ...
  <div class="row">
    ...
    <?php if (isset($veri["veriTabaniYedekle"])) :?>
          <!-- BAŞLIK -->
          ...
          <div class="col-xl-12 col-md-12  text-center"> 
            <div class="row text-center">  
        	    <div class="col-xl-4 col-lg-6 col-md-8 col-sm-10 mx-auto">
                    ...
                    <h4>Veri Tabanı Yedekle</h4>
                  </div>
                  <div class="col-lg-12 col-md-12 col-sm-12 formeleman nocizgi">
                    <?php Form::_form(array("action" => URL."/panel/yedekAl", "method" => "POST"));?>
                  </div>
                  <div class="col-lg-12 col-md-12 col-sm-12 formeleman nocizgi">
                      <?php Form::input(array("type"=>"submit","value"=>"Yedek Al","name"=>"yedekBtn","class"=>"btn btn-primary")); ?>		
                  </div>
                  <div class="col-lg-12 col-md-12 col-sm-12 formeleman nocizgi mvc-renk">
                    <label>Local'e yükle <?php Form::input(array("type"=>"radio","name"=>"yedekTercih","class"=>"mr-2","value"=>"local")); ?> </label>
                    <label>PC'ye yükle  <?php Form::input(array("type"=>"radio", "name"=>"yedekTercih","value"=>"pc")); ?> </label>
                    <?php Form::formkapat("kapat"); ?>
                  </div>  
                  <div class="col-lg-12 col-md-12 col-sm-12 formeleman nocizgi mvc-renk">
                      <?php 		
                        $geldi = $PanelHarici->listele("ayarlar", false);
                        echo "Son yedekleme tarihi : ".$geldi[0]["yedekTarih"];
                      ?>
                  </div>  
             		</div>
              </div>
