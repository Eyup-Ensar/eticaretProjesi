...
<title>MVC-E | E-TİCARET | GİRİŞ</title>
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="p-5">
                  ...
                  <?php  Form::_form(array("action" => URL."/uye/giriskontrol", "method" => "POST"));  ?>
                    <div class="form-group">
                      <?php  Form::input(array("type"=>"text","name"=>"AdminAd","class"=>"form-control form-control-user","autofocus"=>"autofocus","placeholder"=>"Kullanıcı adınızı giriniz")); ?>
                      <?php  Form::input(array("type"=>"hidden","name"=>"girisTipi","value"=>"yoneticiGirisi")); ?>
                    </div>
                    <div class="form-group">
                      <?php  Form::input(array("type"=>"password","name"=>"AdminSifre","class"=>"form-control form-control-user","required"=>"required","id"=>"exampleInputPassword","placeholder"=>"Şifreniz")); ?>
                    </div>
                    <div class="form-group text-center">
                      <?php  Form::input(array("type"=>"submit","name"=>"buton","class"=>"btn btn-danger","value"=>"GİRİŞ YAP")); ?>
                    </div>   
                  <?php  Form::formkapat();  ?>
                </div>
              </div>
