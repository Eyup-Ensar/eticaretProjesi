...
<div class="banner-bottom">
					...
					<li>
							...
							<li>
								...
								<h3> <?php echo $Harici->sloganUst3 ?> </h3>
									<p> <?php echo $Harici->sloganAlt3 ?> </p>
								</div>								
							</li>
						</ul>
					</div>
	...
	<div class="shop">
		<a href="<?php echo URL; ?>/views/single.php">HEMEN BAŞLA</a>
	</div>
	</div>
		</div>
					...
					<?php 
						foreach($veri["data1"] as $value):
							echo '<div class="col-md-4 product simpleCart_shelfItem text-center">
								<a href="'.URL.'/urunler/detay/'.$value["id"].'/'.$Harici->seo($value['urunad']).'"><img src="'.URL.'/views/design/images/'.$value["res1"].'" alt="" /></a>
								<div class="mask">
		...
		<div class="container">
			<h3 class="like text-center">EN ÇOK SATANLAR</h3>  
				     ...
				     <ul id="flexiselDemo3">
						<?php foreach($veri["data2"] as $value): ?>
							<li>
								<a href="<?php echo URL.'/urunler/detay/'.$value['id'].'/'.$Harici->seo($value['urunad']); ?>"><img src="<?php echo URL; ?>/views/design/images/<?php echo $value["res2"]; ?>" class="img-responsive" alt="" /></a>
								<div class="product liked-product simpleCart_shelfItem">
									<a class="like_name" href="<?php echo URL.'/urunler/detay/'.$value['id'].'/'.$Harici->seo($value['urunad']); ?>"><?php echo $value["urunad"]; ?></a>
