...
<div class="products-page">
            ...
            <ul class="product-list">
                <?php 
                    foreach($veri["data2"] as $value):
                        echo '<li><a href="'.URL.'/urunler/kategori/'.$value["id"].'/'.$Harici->seo($value["ad"]).'">'.$value["ad"].'</a></li>';
                    endforeach;
                ?>
            </ul>
        </div>
    ...
    <div class="new-product">
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    ...
                    <select>
                        <option value="" selected="selected"> 9 </option> 15 </option>
                        <option value=""> 30 </option>
                    </select> 
                </div>
                <div class="col-md-4">
                   <h4 style="padding:0; font-weight:bold">ÜRÜN SAYISI : <?php echo isset($veri["toplamveri"]) ? $veri["toplamveri"] : null; ?></h4> 
                </div>
                <div class="col-md-4">
        ...
        <?php if(isset($veri["toplamsayfa"])) : 
          Pagination::paginationNumaralar($veri["toplamsayfa"][0], '/urunler/kategori/'.$veri["toplamsayfa"][1].'/'.$veri["toplamsayfa"][2].'/');
        endif; ?></div>
                ...
                <ul id="flexiselDemo3">
                    <?php
                        foreach($veri["data4"] as $value):
                            echo '
                            <li><a href="'.URL.'/urunler/detay/'.$value['id'].'/'.$Harici->seo($value['urunad']).'"><img src="'.URL.'/views/design/images/'.$value["res1"].'" class="img-responsive"/></a>
